...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        // getFields()는 public만 가져와서 getDeclaredFields를 하여야지 private까직 가져온다.
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(1, "gugu", "제목2", "내용2", new Date(1), 1);
